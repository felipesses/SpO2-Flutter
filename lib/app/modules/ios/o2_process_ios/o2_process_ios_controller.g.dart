...
part of 'o2_process_ios_controller.dart';
...
mixin _$O2ProcessIosController on _O2ProcessIosControllerBase, Store {
  final _$cameraAtom = Atom(name: '_O2ProcessIosControllerBase.camera');
  ...
  final _$cameraInitializedAtom =
      Atom(name: '_O2ProcessIosControllerBase.cameraInitialized');
  ...
  final _$savedImageAtom = Atom(name: '_O2ProcessIosControllerBase.savedImage');
  ...
  final _$totalTimeInSecsAtom =
      Atom(name: '_O2ProcessIosControllerBase.totalTimeInSecs');
  ...
  final _$counterAtom = Atom(name: '_O2ProcessIosControllerBase.counter');
  ...
  final _$initializeCameraAsyncAction =
      AsyncAction('_O2ProcessIosControllerBase.initializeCamera');
  ...
  final _$processCameraImageAsyncAction =
      AsyncAction('_O2ProcessIosControllerBase.processCameraImage');
