...
class O2ProcessPage extends StatefulWidget {
  @override
  _O2ProcessPageState createState() => _O2ProcessPageState();
}

class _O2ProcessPageState extends ModularState<O2ProcessPage, ProcessController>
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: <Widget>[
            Flexible(
              child: Image.asset(
                'assets/images/capasprojeto.png',
                fit: BoxFit.fill,
