...
class O2ResultPage extends StatefulWidget {
  final int o2;
  final int bpm;
  final double r1;

  const O2ResultPage({Key key, this.o2, this.bpm, this.r1}) : super(key: key);

  @override
  _O2ResultPageState createState() => _O2ResultPageState();
}

class _O2ResultPageState extends ModularState<O2ResultPage, ResultController> {
