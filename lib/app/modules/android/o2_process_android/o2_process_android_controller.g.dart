...
part of 'o2_process_android_controller.dart';
...
mixin _$O2ProcessAndroidController on _O2ProcessAndroidControllerBase, Store {
  final _$cameraAtom = Atom(name: '_O2ProcessAndroidControllerBase.camera');
  ...
  final _$cameraInitializedAtom =
      Atom(name: '_O2ProcessAndroidControllerBase.cameraInitialized');
  ...
  final _$savedImageAtom =
      Atom(name: '_O2ProcessAndroidControllerBase.savedImage');
  ...
  final _$totalTimeInSecsAtom =
      Atom(name: '_O2ProcessAndroidControllerBase.totalTimeInSecs');
  ...
  final _$counterAtom = Atom(name: '_O2ProcessAndroidControllerBase.counter');
  ...
  final _$initializeCameraAsyncAction =
      AsyncAction('_O2ProcessAndroidControllerBase.initializeCamera');
  ...
  final _$processCameraImageAsyncAction =
      AsyncAction('_O2ProcessAndroidControllerBase.processCameraImage');
